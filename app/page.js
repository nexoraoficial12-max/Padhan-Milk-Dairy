...
const products = [
  { id:'milk1', img:'/assets/milk.jpg', name:{or:'ତାଜା କ୍ଷୀର',hi:'ताज़ा दूध',en:'Fresh Milk'}, unit:{or:'/ ଲିଟର',hi:'/ लीटर',en:'/ litre'}, price:60 },
  { id:'milk250', img:'/assets/milk.jpg', name:{or:'କ୍ଷୀର 250ml',hi:'दूध 250ml',en:'Milk 250ml'}, unit:{or:'/ ବୋତଲ',hi:'/ बोतल',en:'/ bottle'}, price:15 },
  { id:'paneer250', img:'/assets/paneer.jpg', name:{or:'ପନିର 250g',hi:'पनीर 250g',en:'Paneer 250g'}, unit:{or:'/ ପ୍ୟାକେଟ୍',hi:'/ पैकेट',en:'/ pack'}, price:75 },
  { id:'paneer500', img:'/assets/paneer.jpg', name:{or:'ପନିର 500g',hi:'पनीर 500g',en:'Paneer 500g'}, unit:{or:'/ ପ୍ୟାକେଟ୍',hi:'/ पैकेट',en:'/ pack'}, price:150 },
  { id:'paneer2kg', img:'/assets/paneer.jpg', name:{or:'ପନିର 2kg',hi:'पनीर 2kg',en:'Paneer 2kg'}, unit:{or:'/ ପ୍ୟାକେଟ୍',hi:'/ पैकेट',en:'/ pack'}, price:600 },
  { id:'ghee', img:'/assets/ghee.jpg', name:{or:'ଘିଅ',hi:'घी',en:'Ghee'}, unit:{or:'/ କିଲୋ',hi:'/ किलो',en:'/ kg'}, price:1400 },
  { id:'dahi1', img:'/assets/dahi.jpg', name:{or:'ଦହି 1L',hi:'दही 1L',en:'Curd 1L'}, unit:{or:'/ ଲିଟର',hi:'/ लीटर',en:'/ litre'}, price:60 },
  { id:'dahi350', img:'/assets/dahi-350ml.jpg', name:{or:'ଦହି 350ml',hi:'दही 350ml',en:'Curd 350ml'}, unit:{or:'/ ପ୍ୟାକେଟ୍',hi:'/ पैकेट',en:'/ pack'}, price:20 },
  { id:'ras-medium', img:'/assets/rasagola.jpg', name:{or:'ରସଗୋଲା 10 pcs (Medium)',hi:'रसगुल्ला 10 पीस (Medium)',en:'Rasgulla 10 pcs (Medium)'}, unit:{or:'/ ବକ୍ସ',hi:'/ बॉक्स',en:'/ box'}, price:105 },
  { id:'ras-big', img:'/assets/rasagola.jpg', name:{or:'ରସଗୋଲା 10 pcs (Big)',hi:'रसगुल्ला 10 पीस (Big)',en:'Rasgulla 10 pcs (Big)'}, unit:{or:'/ ବକ୍ସ',hi:'/ बॉक्स',en:'/ box'}, price:180 },
  { id:'peda', img:'/assets/peda.jpg', name:{or:'ପେଡା 20 pcs (Medium)',hi:'पेड़ा 20 पीस (Medium)',en:'Peda 20 pcs (Medium)'}, unit:{or:'/ ବକ୍ସ',hi:'/ बॉक्स',en:'/ box'}, price:120 },
];
...
export default function Home() {
  ...
  function chooseLanguage(l) {
    setLang(l);
    localStorage.setItem('pmd-lang', l);
    setSplash(false);
  }
    ...
    <>
      ...
      <header className="header">
        <div className="top">
          ...
          <a href="#home" className="brand">
            ...
            <div>
              <b>Padhan Milk Dairy</b>
              <span>Freshness • Purity • Healthy Life</span>
            </div>
          </a>
          ...
          <button className="accountBtn" onClick={() => setAccountOpen(true)}>
            👤 {t.account}
          </button>
      ...
      <main id="home">
        ...
        <section className="hero">
          ...
          <img
            ...
            alt="Milk, paneer and dairy products"
          />
        </section>
        ...
        <section className="availability">
          <div>
            ...
            <div>
              ...
              <b>{t.available}</b>
              <em>Available: 325 L</em>
            </div>
          </div>

          <div className="trust">
            <span>🌿 100% Fresh</span>
            <span>🐄 Local Dairy</span>
            <span>✓ Hygienic</span>
          </div>
        </section>
        ...
        <section id="products" className="section">
          ...
          <div className="sectionTitle">
            ...
            <small>Simple • Easy • Mobile Friendly</small>
          </div>
            ...
            {products.map(p => (
              <article className="card" key={p.id}>
                ...
                <div className="cardBody">
                  ...
                  <button className="order" onClick={() => add(p.id)}>
                    🛒 {t.order}
                  </button>
                </div>
        ...
        <section id="payment" className="payment">
          ...
          <div>
            <h2>💳 {t.payment}</h2>
            <p>
              Scan the QR with PhonePe. Payment verification will be
              connected in the backend.
            </p>

            <div className="payOptions">
              <button onClick={() => alert(t.fullPay)}>
                100% {t.fullPay}
              </button>

              <button onClick={() => alert(t.halfPay)}>
                50% {t.halfPay}
              </button>
            </div>
          </div>
          ...
          <img
            ...
            alt="PhonePe QR for Dolamani Padhan"
          />
        ...
        <section className="info">
          ...
          <div>
            <span>🥛</span>
            <h3>Fresh & Local</h3>
            <p>Daily dairy products with a simple ordering experience.</p>
          </div>

          <div>
            <span>📦</span>
            <h3>Safe Packing</h3>
            <p>Milk bottle and paneer packet options are clearly shown.</p>
          </div>

          <div>
            <span>📱</span>
            <h3>Easy on Mobile</h3>
            <p>Large buttons, clear prices and minimal typing.</p>
          </div>
      ...
      <footer id="contact">
        ...
        <div>
          <h3>Address</h3>
          <p>
            India • Odisha • Sundargarh • Hemgir<br/>
            P.O. Bilaimunda • G.P. Mundherkhet<br/>
            Village: Podajhalanga
          </p>

          <a
            target="_blank"
            href="https://maps.app.goo.gl/8CH8FZtQqv2UXQnx7"
          >
            📍 Open Map
          </a>
        </div>
        ...
        <div className="overlay" onClick={() => setCartOpen(false)}>
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            {items.length === 0 ? (
              ...
              <>
                {items.map(x => (
                  <div className="cartRow" key={x.p.id}>
